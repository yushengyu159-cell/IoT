...
# 备份原文件
cp configs/fabric/connection-fixed-certs.yaml configs/fabric/connection-fixed-certs.yaml.backup2
...
echo -e "${GREEN}✅ 已更新主配置文件${NC}"

echo ""
echo -e "${GREEN}🎉 YAML缩进修复完成！${NC}"
echo "==================================" 