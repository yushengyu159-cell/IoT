...
window.LanguageConfig = LanguageConfig;
                ...
                'sms.login': 'SMS Login',
                'sms.login.zh': '短信登录',
                'sms.login.title': 'Login with SMS',
                'sms.login.title.zh': '短信登录',
                'sms.login.subtitle': 'Enter your email to receive verification code',
                'sms.login.subtitle.zh': '输入您的邮箱以接收验证码',
                'sms.email.placeholder': 'Enter your email',
                'sms.email.placeholder.zh': '请输入您的邮箱',
                'sms.send.code': 'Send Verification Code',
                'sms.send.code.zh': '发送验证码',
                'sms.code.placeholder': 'Enter verification code',
                'sms.code.placeholder.zh': '请输入验证码',
                'sms.verify': 'Verify & Login',
                'sms.verify.zh': '验证并登录',
                'sms.sending': 'Sending...',
                'sms.sending.zh': '发送中...',
                'sms.resend': 'Resend',
                'sms.resend.zh': '重新发送',
                'sms.code.sent': 'Verification code sent to your phone',
                'sms.code.sent.zh': '验证码已发送到您的手机',
                'sms.code.send.failed': 'Failed to send verification code',
                'sms.code.send.failed.zh': '发送验证码失败',
                'sms.verify.success': 'Login successful',
                'sms.verify.success.zh': '登录成功',
                'sms.verify.failed': 'Verification code is invalid or expired',
                'sms.verify.failed.zh': '验证码无效或已过期',
                'sms.email.not.found': 'Email not registered',
                'sms.email.not.found.zh': '邮箱未注册',
                'sms.phone.not.found': 'No phone number associated with this account',
                'sms.phone.not.found.zh': '该账号未绑定手机号',
                'sms.code.invalid': 'Invalid verification code',
                'sms.code.invalid.zh': '验证码无效',
                'sms.login.success': 'Login successful, redirecting...',
                'sms.login.success.zh': '登录成功，正在跳转...',
